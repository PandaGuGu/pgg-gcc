...
| P4 | 类型系统补全（**一期 v4=编译器核心子集 B1**：char/指针/数组/字符串/逻辑/do-while·break·continue/复合赋值/全局/强转/注释 → 自举原料；二期=struct/union/enum/typedef/const·volatile/位运算/三目/逗号/switch/sizeof → C90 全量） | C90 | 📋 一期细则 §4.4（2026-08-25 起草）；二期按 §5 |
